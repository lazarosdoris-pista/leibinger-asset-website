    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <section className="relative pt-24 pb-20 px-6 overflow-hidden min-h-screen flex items-center">
          ...
          <video 
            ...
            muted 
            playsInline 
            className="absolute inset-0 w-full h-full object-cover -z-10 opacity-100" preload="auto"
          >
            <source src="/LeibingerHomepage.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        <div className="absolute inset-0 bg-gradient-to-b from-slate-950/70 via-slate-950/50 to-slate-950/70 z-10 opacity-50"></div>
